...
- [DOM vs BOM](https://fe.ecool.fun/topic/6b6a6323-32e3-4082-91a4-d431a88436d9?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
...
- [js 和 css 是否阻塞 DOM 树构建和渲染](https://fe.ecool.fun/topic/9c119d14-fe3b-4f23-9a51-222c50529890?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
...
- [能否使用自闭合 script 标签引入脚本文件?](https://fe.ecool.fun/topic/1592fd61-1555-4646-a2a0-438828b5b8e5?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
...
- [DOMContentLoaded、load、beforeunload、unload](https://fe.ecool.fun/topic/43dad801-6c42-4638-9006-2c51a7cf0c91?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
...
- [渐进增强和优雅降级](https://fe.ecool.fun/topic/79fe443f-0556-4359-8e05-804161ac48ef?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
- [webSocket 如何兼容低浏览器](https://fe.ecool.fun/topic/9f860d42-8504-4562-8b9a-4a415ba5782a?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
- [什么是 HTML5，和 HTML 的区别是什么？](https://fe.ecool.fun/topic/63d73ae0-ea78-4b4c-8a85-6be7513a62a4?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
- [HTML、XML、XHTML 的区别](https://fe.ecool.fun/topic/43f99048-e5ee-4041-a7f4-65a4d5ef379f?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
...
- [<!DOCTYPE html> 标签的作用](https://fe.ecool.fun/topic/ba6327df-ba59-4870-921c-36b8516c4451?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
- [HTML 标签中的 src 和 href 的区别](https://fe.ecool.fun/topic/53060972-481f-4025-a055-aa278d737fc1?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)
